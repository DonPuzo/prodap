...
STRINGS = {
    'en': {
        ...
        'login_button': 'Log in',
        'mfa_verify_heading': 'Enter your authentication code',
        'mfa_verify_instruction': 'Open your authenticator app and enter the current 6-digit code, or use one of your backup codes.',
    ...
    'pcm': {
        ...
        'login_button': 'Log in',
        'mfa_verify_heading': 'Enter your authentication code',
        'mfa_verify_instruction': 'Open your authenticator app, put the current 6-digit code, or use one of your backup codes.',
        'mfa_code_label': 'Authentication code',
        'mfa_verify_button': 'Verify',
