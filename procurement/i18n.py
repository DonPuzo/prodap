...
STRINGS = {
    'en': {
        ...
        'tenders_board_heading': 'Tenders Board Evaluation',
        ...
        'complaint_overdue_note': 'complaint(s) past the institution\'s target response window.',
    ...
    'pcm': {
        ...
        'tenders_board_heading': 'Tenders Board Wetin Dem Check',
        ...
        'complaint_overdue_note': 'complaint(s) don pass the time wey dem suppose respond.',
